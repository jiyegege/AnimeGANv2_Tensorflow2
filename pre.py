...
def parse_args():
    ...
    parser.add_argument('--model_dir', type=str, default='save_model/' + 'generator',
...
def test(checkpoint_dir, style_name, test_dir, if_adjust_brightness, img_size=[256, 256]):
    ...
    test_generated = load_model(checkpoint_dir)
    test_generated.build(input_shape=[1, None, None, 3])
